...
export const OurWorkData: OurWork[] = [
  {
    ...
    link: "social-media-content-strategy",
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Elevate your brand with our expert campaign and graphic design services. Bold visuals, strategic messaging, and impactful campaigns.",
    },
  },
  {
    title: "Monogram logo",
...
from business cards to digital screens.`,
    meta: {
      title: "Logo Design | Sova Creative Studio",
      description:
        "Create a lasting impression with expert logo design. Elegant and professional branding services that create lasting visual identities.",
    },
  },
  {
    title: "Brochure",
...
brand to elevate their message.`,
    meta: {
      title: "Brochure Design | Sova Creative Studio",
      description:
        "Make a lasting impact with expert brochure design. Creative solutions that elevate your brand and engage your audience.",
    },
  },
  {
...
design for a truly great cause.`,
    meta: {
      title: "Brand Identity & Website Design | Sova Creative Studio",
      description:
        "Build a strong foundation with tailored brand identity and responsive website designs. Creative, professional solutions that define your brand’s future.",
    },
  },
  {
    title: "Wine Label",
...
craftsmanship and cultural heritage, this project was recognized and featured by <a href="https://www.designrush.com/" target="_blank">DesignRush</a> in their
<a href="https://www.designrush.com/best-designs/packaging" target="_blank">"Best Designs of 2023-2024"</a> as one of the top Beverage Packaging Designs.`,
    meta: {
      title: "Wine Label Design | Sova Creative Studio",
      description:
        "Elegant, timeless wine label design with custom typography and authentic details that capture the spirit of every bottle.",
    },
  },
  {
...
design magic together!`,
    meta: {
      title: "Video Production & Motion Graphics | Sova Creative Studio",
      description:
        "Transform your ideas into dynamic motion graphics. Expert video production that enhances engagement with compelling visuals.",
    },
  },
  {
...
Who! Whooo!`,
    meta: {
      title: "Custom Branding Services | Sova Creative Studio",
      description:
        "Turn your vehicles into powerful brand ambassadors with custom fleet branding. Bold designs that ensure maximum visibility on the road.",
    },
  },
  {
    title: "Packaging",
...
every piece.`,
    meta: {
      title: "Packaging Design | Sova Creative Studio",
      description:
        "Create a lasting first impression with unique packaging designs. Sophisticated, high-quality solutions that reflect your brand the right way.",
    },
  },
  {
...
mission of creating a brighter, sustainable future.`,
    meta: {
      title: "Modern Logo Design | Sova Creative Studio",
      description:
        "Professional logo design services that create clean, minimalist brand identities. Tailored designs with modern aesthetics and strong visual impact for diverse industries.",
    },
  },
  {
    title: "Event display",
    ...
    alt: "Event display",
    link: "trade-show-displays-design",
    pageTitle: ["SHOW", "TIME"],
...
displays offered both practicality and a professional edge. Want to leave a lasting impression? Whooo
    ...
    meta: {
      title: "Event Displays Design | Sova Creative Studio",
      description:
        "Tailored event design solutions for all types of occasions. From custom banners to full event branding, we craft designs that captivate and leave a lasting impression.",
    },
  },
  {
    title: "Spirit label",
...
rakija samples. Let’s just say our dedication to the craft never wavered - cheers to that!`,
    meta: {
      title: "Rakija Label Design | Sova Creative Studio",
      description:
        "Create a lasting impression with custom label design for exclusive products. Timeless and sophisticated designs with a modern touch, perfect for small-batch spirits and premium brands.",
    },
  },
...
enhanced internal communications within the organization.`,
    meta: {
      title: " Infographic Design | Sova Creative Studio",
      description:
        "Enhance your communications with custom infographic designs. Clear, engaging, and accessible solutions tailored to diverse audiences for maximum impact.",
    },
  },
  {
...
logo to the packaging, every detail of VaBo’s branding is as irresistible as the treats they craft.`,
    meta: {
      title: "Brand Identity & Packaging Design | Sova Creative Studio",
      description:
        ' Expert logo and packaging design services that make your brand "fly". Creative, tailored solutions that make your business stand out.',
    },
  },
  {
    title: "Website",
...
tailored to a specialized artisan market.`,
    meta: {
      title: "Custom Website Design | Sova Creative Studio",
      description:
        "Craft a strong online presence with a custom website. Responsive, modern web design that showcases your brand with clarity and style.",
    },
  },
  {
    ...
    link: "social-media-content-production",
...
message fly. Need engaging social media content? Welcome to our nest. We'll make your brand fly.`,
    meta: {
      title: "Social Media Content Production | Sova Creative Studio",
      description:
        "Create engaging social media content with expert video production and dynamic visuals. Professional content creation that boosts brand presence and audience engagement.",
    },
  },
];
